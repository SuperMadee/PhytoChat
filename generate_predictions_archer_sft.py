...
predictions_save_path = "data/predictions/archer_mistral_predictions_sft.json"

base_model =  "meta-llama/Meta-Llama-3-8B-Instruct"
checkpoint_path = "/raid/ovod/playground/data/jessan/phytochat/ArCHer/checkpoints/phytochat_llama_dpo/trainer.pt"
predictions_save_path = "data/predictions/archer_llama_predictions_sft.json"
...
def query_model(question):
    input_ids = tokenizer.encode(f"Answer the question in a few words or in one sentence.\n\nQuestion:{question}\nAnswer: ", return_tensors="pt").to('cuda')
