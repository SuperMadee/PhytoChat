...
conversations_path = "data/sft/conversations.json"
...
def main():
    ...
    for conversation in conversations:
        ...
        # randomly cut off the conversation to simulate a training example
        indices = list(range(3, len(messages)+1, 2))
    ...
    train.to_parquet('data/sft/train.parquet', index=False)
    test.to_parquet('data/sft/test.parquet', index=False)
